...
export const contacts = {
  ...
  socials: [
    ...
    { label: "YouTube", value: "@itsurboimasarou", href: "https://youtube.com/@itsurboimasarou" },
    ...
    { label: "TikTok (2nd account)", value: "@masarou.photophone", href: "https://tiktok.com/@masarou.photophone" },
